  ...
  return (
    <section id="marcas" className="py-16 md:py-24 px-4 relative overflow-hidden">
      ...
      <div 
        ...
        style={{ background: 'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(255,255,255,0.6) 0%, rgba(255,255,255,0.2) 30%, transparent 70%)' }}
      ></div>
      ...
      <div 
        ...
        style={{
          backgroundImage: `repeating-linear-gradient(45deg, transparent, transparent 25px, #1E3A5F 25px, #1E3A5F 50px), repeating-linear-gradient(-45deg, transparent, transparent 25px, #C0392B 25px, #C0392B 50px)`,
            ...
            <div className="hidden md:grid md:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-6">
              {projectImages.map((image) => (
                <div
                  ...
                  className="relative group cursor-pointer overflow-hidden rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] aspect-square focus:outline-none focus:ring-4 focus:ring-[#1E3A5F]/30"
